...
Each can be critical to learning, each in it's own unique way. Competitive play is freely and equally available to almost everyone, but exploratory play is not. 
